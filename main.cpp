...
std::cout<<"operator+: "<<(*r1+r3)<<"/n";
std::cout<<"R1==R1"<< (*r1==*r1?"true":"false")<<"\n";
...
auto low=std::shared_ptr<Robot>& r){return r->battery()<20;});
if(low!=all.end())std::cout<<"Low_battery: "<<**low<<"\n";
fleet.charge_all();
//background Thread
auto r2=std::dynamic_pointer_casr<MobileRobot>(fleet.find("R2"));
